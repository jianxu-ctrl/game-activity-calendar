...
export function UITextEditor({ uiText, setUiText }: { uiText: Record<string, any>; setUiText: React.Dispatch<React.SetStateAction<Record<string, any>>> }) {
  ...
  const fields: [string, string][] = [
    ...
    ["selectConfigFolder", "Select Config Folder Button"],
    ["refreshConfigFolder", "Update Folder Button"],
    ["configFolderLabel", "Config Folder Label"],
    ["configFolderHint", "Config Folder Hint"],
    ...
    ["importTransifyCurrent", "Import Used Keys Button"],
    ["importTransifyFullLanguage", "Import Full Language Button"],
    ["importTransifyAll", "Import Full All Languages Button"],
    ["transifyImportHint", "Transify Import Hint"],
