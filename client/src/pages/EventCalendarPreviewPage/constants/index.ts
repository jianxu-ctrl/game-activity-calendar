...
export const DEFAULT_UI_TEXT = {
  ...
  refreshConfigFolder: "Update Folder",
  configFolderLabel: "Config Folder",
  configFolderHint: "Choose a folder that contains Event.xlsx, CDNConfig.xlsx, Merchant.xlsx, Mission.xlsx, Reward.xlsx, Item.xlsx and Gacha.xlsx.",
  ...
  importTransifyCurrent: "Import Used Keys",
  importTransifyFullLanguage: "Import Full Language",
  importTransifyAll: "Import Full All Languages",
  transifyImportHint: "Used Keys imports only keys parsed from the current config. Full imports the whole Transify resource.",
